...
-- Add comments
COMMENT ON TABLE custom_product_categories IS 'Categories for grouping custom product types';
COMMENT ON TABLE custom_product_columns IS 'Columns/attributes within a category';
COMMENT ON TABLE custom_product_options IS 'Options within a column';
...
INSERT INTO custom_product_categories (name, description, order_index) VALUES
    ('Furniture', 'Furniture products and items', 1),
