...
-- This script will delete existing data and insert comprehensive sample data

-- Start transaction
BEGIN;

-- Delete existing data in reverse dependency order
-- Delete budget lines first (has foreign key to budgets)
...
-- Delete credit memos and related tables
DELETE FROM credit_memo_applications;
DELETE FROM credit_memo_refunds;
DELETE FROM credit_memos;

-- Delete journal entry lines first (has foreign key to journal entries)
...
-- (PostgreSQL doesn't have sequences for UUID columns, but this is here for completeness)
...
('33333333-3333-3333-3333-333333333334', 'INV-2024-003', '33333333-3333-3333-3333-333333333333', NULL, '2024-02-15', '2024-02-15', 5000000, 10.0, 500000, 5500000, 'VND', 'sent', 'paid', 5500000, '[{"description": "Tư vấn IT", "quantity": 10, "unit_price": 500000, "total": 5000000}]', 'Thanh toán ngay', NOW(), NOW()),
('44444444-4444-4444-4444-444444444445', 'INV-2024-004', '44444444-4444-4444-4444-444444444444', 'dddddddd-dddd-dddd-dddd-dddddddddddd', '2024-03-01', '2024-04-15', 75000000, 10.0, 7500000, 82500000, 'VND', 'sent', 'pending', 0, '[{"description": "Giai đoạn 1 App Mobile", "quantity": 1, "unit_price": 75000000, "total": 75000000}]', 'Chưa thanh toán', NOW(), NOW()),
('55555555-5555-5555-5555-555555555556', 'INV-2024-005', '55555555-5555-5555-5555-555555555555', 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', '2024-03-15', '2024-04-14', 15000000, 10.0, 1500000, 16500000, 'VND', 'sent', 'overdue', 0, '[{"description": "Dịch vụ bảo trì Q1", "quantity": 1, "unit_price": 15000000, "total": 15000000}]', 'Quá hạn thanh toán', NOW(), NOW());
