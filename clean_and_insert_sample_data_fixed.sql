-- Clean existing data and insert fresh sample data for testing all reports
-- This script will delete existing data and insert comprehensive sample data with valid UUIDs
...
-- Now insert fresh sample data with valid UUIDs
...
('11111111-1111-1111-1111-111111111111', 'CUST001', 'Cong ty TNHH ABC', 'company', 'contact@abc.com', '0123456789', '123 Duong ABC, Quan 1', 'TP.HCM', 'Vietnam', '0123456789', 'active', 'Khach hang VIP', NOW(), NOW()),
...
('44444444-4444-4444-4444-444444444444', 'CUST004', 'Tap doan GHI', 'company', 'ceo@ghi.com', '0147258369', '321 Duong GHI, Quan 7', 'TP.HCM', 'Vietnam', '0147258369', 'active', 'Khach hang lon', NOW(), NOW()),
('55555555-5555-5555-5555-555555555555', 'CUST005', 'Cong ty JKL', 'company', 'admin@jkl.com', '0258147369', '654 Duong JKL, Quan 10', 'TP.HCM', 'Vietnam', '0258147369', 'active', 'Khach hang moi', NOW(), NOW());
...
('66666666-6666-6666-6666-666666666666', 'VEND001', 'Nha cung cap MNO', 'Hoang Van F', 'supplier@mno.com', '0369258147', '987 Duong MNO, Quan 4', 'TP.HCM', 'Vietnam', '0369258147', 30, true, 'Nha cung cap chinh', NOW(), NOW()),
('77777777-7777-7777-7777-777777777777', 'VEND002', 'Cong ty PQR', 'Vu Thi G', 'contact@pqr.com', '0471852963', '147 Duong PQR, Quan 5', 'TP.HCM', 'Vietnam', '0471852963', 15, true, 'Nha cung cap phu', NOW(), NOW()),
('88888888-8888-8888-8888-888888888888', 'VEND003', 'Tap doan STU', 'Dang Van H', 'info@stu.com', '0582963741', '258 Duong STU, Quan 6', 'TP.HCM', 'Vietnam', '0582963741', 45, true, 'Nha cung cap lon', NOW(), NOW()),
('99999999-9999-9999-9999-999999999999', 'VEND004', 'Cong ty VWX', 'Bui Thi I', 'sales@vwx.com', '0693074852', '369 Duong VWX, Quan 8', 'TP.HCM', 'Vietnam', '0693074852', 0, true, 'Nha cung cap dia phuong', NOW(), NOW()),
('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'VEND005', 'Doanh nghiep YZ', 'Ly Van J', 'admin@yz.com', '0704185926', '741 Duong YZ, Quan 9', 'TP.HCM', 'Vietnam', '0704185926', 30, true, 'Nha cung cap chuyen nghiep', NOW(), NOW());
...
('dddddddd-dddd-dddd-dddd-dddddddddddd', 'PRJ003', 'App Mobile GHI', 'Phat trien ung dung di dong cho tap doan GHI', '44444444-4444-4444-4444-444444444444', NULL, '2024-03-01', '2024-09-30', 150000000, 'active', 'medium', 30.0, NOW(), NOW()),
('eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', 'PRJ004', 'Bao tri JKL', 'Dich vu bao tri he thong cho cong ty JKL', '55555555-5555-5555-5555-555555555555', NULL, '2024-01-15', '2024-12-31', 30000000, 'active', 'low', 60.0, NOW(), NOW()),
...
('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbc', 'EXP-2024-001', NULL, 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'travel', 'Di cong tac Ha Noi', 5000000, 'VND', '2024-01-15', NULL, 'approved', NULL, '2024-01-20', 'Chi phi di lai va an o', NOW(), NOW()),
('cccccccc-cccc-cccc-cccc-cccccccccccd', 'EXP-2024-002', NULL, 'cccccccc-cccc-cccc-cccc-cccccccccccc', 'meals', 'Tiep khach doi tac', 3000000, 'VND', '2024-02-10', NULL, 'approved', NULL, '2024-02-12', 'An toi voi khach hang', NOW(), NOW()),
('dddddddd-dddd-dddd-dddd-ddddddddddde', 'EXP-2024-003', NULL, 'dddddddd-dddd-dddd-dddd-dddddddddddd', 'supplies', 'Mua thiet bi van phong', 2000000, 'VND', '2024-03-05', NULL, 'pending', NULL, NULL, 'Mua may in va giay', NOW(), NOW()),
('eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeef', 'EXP-2024-004', NULL, 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', 'training', 'Khoa hoc chuyen mon', 8000000, 'VND', '2024-03-20', NULL, 'approved', NULL, '2024-03-25', 'Hoc phi khoa hoc AWS', NOW(), NOW()),
('ffffffff-ffff-ffff-ffff-ffffffffffff', 'EXP-2024-005', NULL, NULL, 'other', 'Chi phi khac', 1500000, 'VND', '2024-04-01', NULL, 'rejected', NULL, '2024-04-02', 'Chi phi khong hop le', NOW(), NOW());
...
('88888888-8888-8888-8888-88888888888b', 'EC-2024-001', NULL, '2024-01-25', 'Chi phi cong tac thang 1', '[{"description": "Ve may bay", "amount": 3000000, "category": "travel"}, {"description": "Khach san", "amount": 2000000, "category": "accommodation"}]', 5000000, 'VND', 'paid', NULL, '2024-01-30', NULL, '2024-02-05', 'Da thanh toan day du', NOW(), NOW()),
('99999999-9999-9999-9999-99999999999c', 'EC-2024-002', NULL, '2024-02-20', 'Chi phi tiep khach', '[{"description": "An toi voi doi tac", "amount": 2500000, "category": "meals"}]', 2500000, 'VND', 'approved', NULL, '2024-02-25', NULL, NULL, 'Cho thanh toan', NOW(), NOW()),
('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaad', 'EC-2024-003', NULL, '2024-03-15', 'Chi phi dao tao', '[{"description": "Khoa hoc online", "amount": 3000000, "category": "training"}]', 3000000, 'VND', 'submitted', NULL, NULL, NULL, NULL, 'Dang cho phe duyet', NOW(), NOW());
...
('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbe', 'Ngan sach Q1 2024', 'Quarterly', '2024-01-01', '2024-03-31', 100000000, 'approved', NULL, '2024-01-01', 'Ngan sach quy 1 cho tat ca du an', NULL, NOW(), NOW()),
('cccccccc-cccc-cccc-cccc-cccccccccccf', 'Ngan sach Marketing 2024', 'Yearly', '2024-01-01', '2024-12-31', 50000000, 'approved', NULL, '2024-01-01', 'Ngan sach marketing ca nam', NULL, NOW(), NOW()),
('dddddddd-dddd-dddd-dddd-dddddddddddg', 'Ngan sach Q2 2024', 'Quarterly', '2024-04-01', '2024-06-30', 120000000, 'draft', NULL, NULL, 'Ngan sach quy 2 dang soan thao', NULL, NOW(), NOW());
