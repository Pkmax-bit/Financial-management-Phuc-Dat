...
const quickGuides = [
  ...
  {
    id: 'sales-workflow',
    title: 'Quy trình bán hàng hoàn chỉnh',
  ...
  {
    id: 'expense-workflow',
    title: 'Quy trình quản lý chi phí',
    description: 'Từ ngân sách đến thanh toán',
    steps: [
  ...
  },
  {
    ...
    title: 'Quản lý ngân sách hiệu quả',
    description: 'Thiết lập và theo dõi ngân sách',
    steps: [
      ...
      'Tạo báo cáo so sánh ngân sách'
    ],
    estimatedTime: '15 phút'
  }
]

export default function SupportGuidesTab({ searchTerm, onCreateGuide }: SupportGuidesTabProps) {
  return (
