...
export default function CreateQuoteSidebar({ isOpen, onClose, onSuccess }: CreateQuoteSidebarProps) {
  ...
  return (
    <>
      ...
      <div className={`fixed top-0 right-0 h-full w-full md:w-[90%] lg:w-[1200px] max-w-full bg-white shadow-2xl transform transition-transform duration-300 ease-in-out z-50 ${isOpen ? 'translate-x-0' : 'translate-x-full'
        }`}>
