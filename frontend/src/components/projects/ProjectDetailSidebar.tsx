        ...
        <div className="p-6 space-y-6">
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 min-w-0">
              <h3 className="text-lg font-semibold text-gray-900 break-words" title={project.name}>{project.name}</h3>
              <p className="text-sm text-black">#{project.project_code}</p>
              {project.description && (
                <p className="text-sm text-black mt-2 break-words">{project.description}</p>
              )}
            </div>
          </div>
