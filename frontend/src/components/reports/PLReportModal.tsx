            ...
            <div className="p-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-gray-600">{report?.report_period || `${startDate} - ${endDate}`}</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-gray-700">Mô tả</label>
                  <p className="text-sm text-gray-600">Báo cáo chi tiết về doanh thu, chi phí và lợi nhuận của công ty</p>
                </div>
              </div>
            </div>
          </div>
