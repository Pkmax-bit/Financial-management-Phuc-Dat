...
-- and simple text without any problematic characters
...
('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbc', 'EXP-2024-001', '11111111-1111-1111-1111-111111111111', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'travel', 'Di cong tac Ha Noi', 5000000, 'VND', '2024-01-15', NULL, 'approved', NULL, '2024-01-20', 'Chi phi di lai va an o', NOW(), NOW()),
('cccccccc-cccc-cccc-cccc-cccccccccccd', 'EXP-2024-002', '22222222-2222-2222-2222-222222222222', 'cccccccc-cccc-cccc-cccc-cccccccccccc', 'meals', 'Tiep khach doi tac', 3000000, 'VND', '2024-02-10', NULL, 'approved', NULL, '2024-02-12', 'An toi voi khach hang', NOW(), NOW()),
('dddddddd-dddd-dddd-dddd-ddddddddddde', 'EXP-2024-003', '33333333-3333-3333-3333-333333333333', 'dddddddd-dddd-dddd-dddd-dddddddddddd', 'supplies', 'Mua thiet bi van phong', 2000000, 'VND', '2024-03-05', NULL, 'pending', NULL, NULL, 'Mua may in va giay', NOW(), NOW()),
('eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeef', 'EXP-2024-004', '44444444-4444-4444-4444-444444444444', 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', 'training', 'Khoa hoc chuyen mon', 8000000, 'VND', '2024-03-20', NULL, 'approved', NULL, '2024-03-25', 'Hoc phi khoa hoc AWS', NOW(), NOW()),
('ffffffff-ffff-ffff-ffff-ffffffffffff', 'EXP-2024-005', '55555555-5555-5555-5555-555555555555', NULL, 'other', 'Chi phi khac', 1500000, 'VND', '2024-04-01', NULL, 'rejected', NULL, '2024-04-02', 'Chi phi khong hop le', NOW(), NOW());
...
('eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeef', '33333333-3333-3333-3333-333333333336', '3331', 'Thue GTGT phai nop', 0, 5000000, 'Thue GTGT 10%', NULL, 'tax', NOW()),
...
('88888888-8888-8888-8888-88888888888b', 'EC-2024-001', '11111111-1111-1111-1111-111111111111', '2024-01-25', 'Chi phi cong tac thang 1', '[{"description": "Ve may bay", "amount": 3000000, "category": "travel"}, {"description": "Khach san", "amount": 2000000, "category": "accommodation"}]', 5000000, 'VND', 'paid', NULL, '2024-01-30', NULL, '2024-02-05', 'Da thanh toan day du', NOW(), NOW()),
('99999999-9999-9999-9999-99999999999c', 'EC-2024-002', '22222222-2222-2222-2222-222222222222', '2024-02-20', 'Chi phi tiep khach', '[{"description": "An toi voi doi tac", "amount": 2500000, "category": "meals"}]', 2500000, 'VND', 'approved', NULL, '2024-02-25', NULL, NULL, 'Cho thanh toan', NOW(), NOW()),
('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaad', 'EC-2024-003', '33333333-3333-3333-3333-333333333333', '2024-03-15', 'Chi phi dao tao', '[{"description": "Khoa hoc online", "amount": 3000000, "category": "training"}]', 3000000, 'VND', 'submitted', NULL, NULL, NULL, NULL, 'Dang cho phe duyet', NOW(), NOW());
...
('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbe', 'Ngan sach Q1 2024', 'Quarterly', '2024-01-01', '2024-03-31', 100000000, 'approved', NULL, '2024-01-01', 'Ngan sach quy 1 cho tat ca du an', '11111111-1111-1111-1111-111111111111', NOW(), NOW()),
('cccccccc-cccc-cccc-cccc-cccccccccccf', 'Ngan sach Marketing 2024', 'Yearly', '2024-01-01', '2024-12-31', 50000000, 'approved', NULL, '2024-01-01', 'Ngan sach marketing ca nam', '22222222-2222-2222-2222-222222222222', NOW(), NOW()),
('dddddddd-dddd-dddd-dddd-dddddddddddg', 'Ngan sach Q2 2024', 'Quarterly', '2024-04-01', '2024-06-30', 120000000, 'draft', NULL, NULL, 'Ngan sach quy 2 dang soan thao', '33333333-3333-3333-3333-333333333333', NOW(), NOW());
