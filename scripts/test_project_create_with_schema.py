"""
Script để test tạo project với dữ liệu phù hợp với schema
"""
import sys
import io
...
def test_create_project():
    """Test tạo project với dữ liệu phù hợp schema"""
    print("=" * 100)
    print("TEST TẠO PROJECT VỚI SCHEMA VALIDATION")
    print("=" * 100)
    print()
    ...
    # Lấy sample IDs
    print("Bước 2: Lấy sample IDs từ database...")
    ...
    print("Bước 3: Generate project code từ backend...")
    headers = {
    ...
    # Tạo project data phù hợp với schema
    print("Bước 4: Tạo project với dữ liệu phù hợp schema...")
    project_data = {
        "project_code": project_code,
        "name": f"Test Project Schema Validation - {datetime.now().strftime('%H%M%S')}",
        "description": "Test project để verify schema compatibility",
    ...
    if sample_ids.get('status_id'):
        ...
        # Không gửi status enum nếu có status_id
    else:
    ...
    try:
        ...
        if response.status_code in [200, 201]:
            ...
            if tasks_resp.status_code == 200:
                ...
                if len(tasks) == 0:
                    print("   ⚠️  CHƯA CÓ TASKS! Có thể trigger chưa chạy hoặc có lỗi.")
            else:
